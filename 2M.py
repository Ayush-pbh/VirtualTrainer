	...
	while god_loop_run:
		...
		try:
			...
			if not inmenu and d2 < 0.2 and angleCalc(right_shoulder, right_elbow, right_wrist) < 180 and angleCalc(right_shoulder, right_elbow, right_wrist) > 130 :
				...
				cv2.rectangle(image,(170, 190), (470, 290), (123,89,34),3)
			...
			if inmenu:
				...
				track_hands = True
				# menu dummy recangle
				cv2.rectangle(image,(170, 190), (470, 290), (123,89,34),10)

				#close menu rectangle
				cv2.rectangle(image,(270, 410), (370, 470), (123,89,34),-1)
				cv2.putText(image,"close menu",(270, 430), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255,255,255), 1, cv2.LINE_AA)
				...
				if mainmenu and circleCentre[1] >190 and circleCentre[1]<290:
					if circleCentre[0] > 170 and circleCentre[0] < 270:
						cv2.rectangle(image,(170, 190), (270, 290), (123,29,254),-1)
						cv2.putText(image,"Exercises",(170,220), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (255,255,255), 1, cv2.LINE_AA)
						selected_option = 1
					if circleCentre[0] > 270 and circleCentre[0] < 370:
						cv2.rectangle(image,(270, 190), (370, 290), (123,29,254),-1)
						cv2.putText(image,"Exit",(270,220), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (255,255,255), 1, cv2.LINE_AA)    
						selected_option = 2
					if circleCentre[0] > 370 and circleCentre[0] < 470:
						cv2.rectangle(image,(370, 190), (470, 290), (123,29,254),-1)
						cv2.putText(image,"Music",(370,220), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (255,255,255), 1, cv2.LINE_AA)    
						selected_option = 3
				if circleCentre[0] > 270 and circleCentre[0] < 370 and circleCentre[1] > 410 and circleCentre[1] < 470 :
					selected_option = 4
				...
				if results_hands.multi_hand_landmarks:
					for handLms in results_hands.multi_hand_landmarks:
						...
						if angleCalc([handLms.landmark[8].x,handLms.landmark[8].y], [handLms.landmark[6].x,handLms.landmark[6].y], [handLms.landmark[5].x,handLms.landmark[5].y]) < 20 or angleCalc([handLms.landmark[12].x,handLms.landmark[12].y], [handLms.landmark[10].x,handLms.landmark[10].y], [handLms.landmark[9].x,handLms.landmark[9].y]) < 20 :
							...
							if selected_option == 4:
								print("Closing Menu")
								inmenu = False
				cv2.circle(image, circleCentre, 15, (255,255,255), 3)			#tracker circle
